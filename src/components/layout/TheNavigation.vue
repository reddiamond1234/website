<template>
  <nav class="fixed top-[60px] md:top-[90px] left-0 w-full bg-primary-600 flex items-center z-40 shadow-md flex-wrap">
    ...
    <button
      class="md:hidden text-2xl py-2 px-3 text-white w-full text-center hover:bg-primary-700 active:bg-primary-800 transition-colors focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-primary-600 focus:outline-none"
      @click="toggleMenu"
    ...
    <ul
      role="menu"
      :class="[
        'w-full m-0 p-0 list-none md:flex md:justify-around overflow-hidden md:overflow-visible transition-all duration-300 ease-in-out',
    ...
    >
      ...
      <!-- Language Dropdown -->
      <li role="menuitem" class="relative flex-1 text-center text-white border-r-0 hover:bg-primary-700 transition-colors">
        <button
